...
<table class="table">
  ...
  where statusID = '3' ORDER BY complaint.c_id DESC LIMIT " . $this_page_first_result . "," .  $results_per_page ;
...
<nav aria-label="Page navigation mb-3">
  <ul class="pagination justify-content-center">
    ...
    for ($page=1;$page<=$number_of_pages;$page++) {
      echo '<li class="page-item"><a class="page-link" href="dismissed.php?page=' . $page . '">' . $page . '</a></li> ';
    }
    ?>
  </ul>
</nav>
